...
public class TerrainInspector : MonoBehaviour {
    ...
    public class TerrainBiomeRatio
    {
        ...
        {
            forestValue = new Attribute(Attribute.AttributeKey.biomeForest, forest);
            grasslandsValue = new Attribute(Attribute.AttributeKey.biomeGrasslands, grasslands);
            tundraValue = new Attribute(Attribute.AttributeKey.biomeTundra, tundra);
        }
    }
